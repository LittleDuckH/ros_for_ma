...
#define NODE_MAIN_LOGGER_NAME "serial_example_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libserial_example.a";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<SerialPortNode>";
